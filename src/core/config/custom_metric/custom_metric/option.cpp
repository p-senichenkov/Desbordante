...
Option<CustomMetricOptionType> MetricOption(CustomMetricOptionType* value_ptr, std::string_view name,
                                      std::string_view description) {
    Option<CustomMetricOptionType> option{value_ptr, name, description, CustomMetricOptionType{nullptr}};
