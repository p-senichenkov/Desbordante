...
CSVConfig const kIowa100k = CreateCsvConfig("iowa100k.csv", ',', true);
CSVConfig const kIowa200k = CreateCsvConfig("iowa200k.csv", ',', true);
...
CSVConfig const kTestBool = CreateCsvConfig("TestBool.csv", ',', false);
CSVConfig const kTestDiacritics = CreateCsvConfig("TestDiacritics.csv", ',', true);
