...
CSVConfig const kCIPublicHighway17attr45k = CreateCsvConfig("CIPublicHighway17attr45k.csv", ',', true);
...
CSVConfig const kMushroomAndCIPublicHighway700 = CreateCsvConfig("mushroomAndCIPublicHighway700.csv", ',', true);
