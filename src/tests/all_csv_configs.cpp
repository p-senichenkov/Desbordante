...
CSVConfig const kAdult8attr100 = CreateCsvConfig("adult8attr100.csv", ';', false);
...
CSVConfig const kCIPublicHighway200k = CreateCsvConfig("CIPublicHighway200k.csv", ',', true);
CSVConfig const kCIPublicHighway10attr = CreateCsvConfig("CIPublicHighway10attr.csv", ',', true);
CSVConfig const kCIPublicHighway15attr40k = CreateCsvConfig("CIPublicHighway15attr40k.csv", ',', true);
...
CSVConfig const kIowa500k = CreateCsvConfig("iowa500k.csv", ',', true);
CSVConfig const kIowa600k = CreateCsvConfig("iowa600k.csv", ',', true);
CSVConfig const kIowa900k = CreateCsvConfig("iowa900k.csv", ',', true);
...
CSVConfig const kMushroomAndCIPublicHighway500 = CreateCsvConfig("mushroomAndCIPublicHighway500.csv", ',', true);
...
CSVConfig const kNeighbors120k = CreateCsvConfig("neighbors120k.csv", ',', true);
CSVConfig const kNeighbors130k = CreateCsvConfig("neighbors130k.csv", ',', true);
