...
CSVConfig const kAdult5attr100 = CreateCsvConfig("adult5attr100.csv", ';', false);
...
CSVConfig const kCIPublicHighway20attr50k = CreateCsvConfig("CIPublicHighway20attr50k.csv", ',', true);
...
CSVConfig const kMushroomAndCIPublicHighway800 = CreateCsvConfig("mushroomAndCIPublicHighway800.csv", ',', true);
