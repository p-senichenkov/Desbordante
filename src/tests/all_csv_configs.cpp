...
CSVConfig const kCIPublicHighway5attr10k = CreateCsvConfig("CIPublicHighway5attr10k.csv", ',', true);
...
CSVConfig const kMushroom2k = CreateCsvConfig("mushroom2k.csv", ',', true);
